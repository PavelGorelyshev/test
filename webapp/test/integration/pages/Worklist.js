sap.ui.define([
		...
		"jbmeeting/MeetingManager/test/integration/pages/shareOptions"
			...
			onTheWorklistPage : {
						...
						return this.waitFor(createWaitForItemAtPosition({
							...
							success : function (oTableItem) {
								...
								this.getContext().currentItem = {
									...
									id: oBindingContext.getProperty("MeetingHeaderID"),
									name: oBindingContext.getProperty("MeetingHeaderText")
								};
							}
						}));
					},
				...
				assertions: jQuery.extend({
					...
					theTableShouldHaveAllEntries : function () {
						...
						// retrieve all jbmeeting_base_MeetingHeaders to be able to check for the total amount
						this.waitFor(this.createAWaitForAnEntitySet({
							entitySet: "jbmeeting_base_MeetingHeaders",
