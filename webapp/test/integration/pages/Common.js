sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("jbmeeting/MeetingManager/app", ".html");
		...
		return Opa5.extend("jbmeeting.MeetingManager.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["jbmeeting/MeetingManager/localService/mockserver"], function (mockserver) {
